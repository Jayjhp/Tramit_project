...
public class ReviewBoardDetailService implements CommandProcess {
	...
	public String requestProcess(
		...
		ReviewBoard rb = rdao.getReviewBoard(Integer.valueOf(no), true);
 
		ArrayList<Reply> replyList = 
				rdao.getReplyList(Integer.valueOf(no));
