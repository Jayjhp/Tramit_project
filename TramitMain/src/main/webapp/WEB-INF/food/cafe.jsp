...
<%
    ...
    if (category == null) category = "커피,디저트"; // 기본 카테고리 설정
...
<div class="products">
  <div class="container">
    ...
    <div class="col-md-12 mb-4 d-flex justify-content-between align-items-center">
      ...
      <form method="GET" action="cafe.mvc">
    ...
    <div class="col-md-12">
      ...
      <div class="col-lg-4 col-md-4 all">
        <div class="product-item">
          <button onclick="location.href='cafe2.mvc'" class="image-button">
  			<img src="<%= r.getImageUrl() %>" alt="<%= r.getName() %>">
		  </button>
          <div class="down-content">
            <button onclick="location.href='cafe2.mvc'" class="image-button"><h4><%= r.getName() %></h4></button>
